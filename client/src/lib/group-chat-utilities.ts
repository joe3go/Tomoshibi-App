...
export const getPersonaDisplayColor = (personaName: string): string => {
  const colorMap: Record<string, string> = {
    'Keiko': 'bg-rose-100 text-rose-800 border-rose-200',
    'Aoi': 'bg-emerald-100 text-emerald-800 border-emerald-200',
    'Haruki': 'bg-orange-100 text-orange-800 border-orange-200',
    'Satoshi': 'bg-blue-100 text-blue-800 border-blue-200',
    'Yuki': 'bg-purple-100 text-purple-800 border-purple-200',
    'Ren': 'bg-indigo-100 text-indigo-800 border-indigo-200',
  };
  
  return colorMap[personaName] || 'bg-gray-100 text-gray-800 border-gray-200';
};
